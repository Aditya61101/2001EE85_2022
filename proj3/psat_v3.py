...
def fk():
    ...
    #inputs to be taken from the user at the front-end side
    constant_fk2d=float(sys.argv[1])
    multiplying_factor_3d=float(sys.argv[2])
    Shear_velocity=float(sys.argv[3])
...
print('1. previous point','2. 2*last-2nd_last','3. overall_mean',
      ...
      '6. all sequential','7. all parallel', sep='\n')
sch = int(sys.argv[9])
